var t = Object.defineProperty,
    ...
    a = (t, e) => {
        ...
        if (r)
            for (var n of r(e)) i.call(e, n) && s(t, n, e[n]);
        return t
    },
    l = (t, r) => e(t, n(r)),
    u = (t, e) => {
...
function h(t, e = {}, ...n) {
    ...
    const r = ["svg", "use", "path", "circle", "g"].includes(t) ? document.createElementNS("http://www.w3.org/2000/svg", t) : document.createElement(t);
    for (const o of Object.keys(e || {})) "function" == typeof e[o] && o.startsWith("on") ? r.addEventListener(o.substr(2).toLowerCase(), e[o]) : "xlink:href" === o ? r.setAttributeNS("http://www.w3.org/1999/xlink", "href", e[o]) : r.setAttribute(o, e[o]);
    n = n.reduce(((t, e) => Array.isArray(e) ? [...t, ...e] : [...t, e]), []);
    for (const o of n) "string" == typeof o || "number" == typeof o ? r.appendChild(document.createTextNode(o)) : o instanceof HTMLElement || o instanceof SVGElement ? r.appendChild(o) : console.error("Impossible d'ajouter l'élément", o, typeof o);
    return r
}
const p = function (t) {
    for (var e, n, r = arguments, o = 1, i = "", s = "", a = [0], l = function (t) {
            1 === o && (t || (i = i.replace(/^\s*\n\s*|\s*\n\s*$/g, ""))) ? a.push(t ? r[t] : i) : 3 === o && (t || i) ? (a[1] = t ? r[t] : i, o = 2) : 2 === o && "..." === i && t ? a[2] = Object.assign(a[2] || {}, r[t]) : 2 === o && i && !t ? (a[2] = a[2] || {})[i] = !0 : o >= 5 && (5 === o ? ((a[2] = a[2] || {})[n] = t ? i ? i + r[t] : r[t] : i, o = 6) : (t || i) && (a[2][n] += t ? i + r[t] : i)), i = ""
        }, u = 0; u < t.length; u++) {
        u && (1 === o && l(), l(u));
        for (var c = 0; c < t[u].length; c++) e = t[u][c], 1 === o ? "<" === e ? (l(), a = [a, "", null], o = 3) : i += e : 4 === o ? "--" === i && ">" === e ? (o = 1, i = "") : i = e + i[0] : s ? e === s ? s = "" : i += e : '"' === e || "'" === e ? s = e : ">" === e ? (l(), o = 1) : o && ("=" === e ? (o = 5, n = i, i = "") : "/" === e && (o < 5 || ">" === t[u][c + 1]) ? (l(), 3 === o && (a = a[0]), o = a, (a = a[0]).push(this.apply(null, o.slice(1))), o = 0) : " " === e || "\t" === e || "\n" === e || "\r" === e ? (l(), o = 2) : i += e), 3 === o && "!--" === i && (o = 4, a = a[0])
    }
...
function E(t, e = 500) {
    return new Promise((n => {
        ...
        t.style.overflow = "hidden", t.style.height = 0, t.style.paddingTop = 0, t.style.paddingBottom = 0, t.style.marginTop = 0, t.style.marginBottom = 0, t.offsetHeight, t.style.transitionProperty = "height, margin, padding", t.style.transitionDuration = `${e}ms`, t.style.height = `${o}px`, t.style.removeProperty("padding-top"), t.style.removeProperty("padding-bottom"), t.style.removeProperty("margin-top"), t.style.removeProperty("margin-bottom"), window.setTimeout((() => {
            t.style.removeProperty("height"), t.style.removeProperty("overflow"), t.style.removeProperty("transition-duration"), t.style.removeProperty("transition-property"), n(t)
        }), e)
    }))
}
...
function k(t) {
    ...
    const e = c(t),
        ...
        r = v();
    let o = e - 100;
    n <= r && (o = e - (r - n) / 2), window.scrollTo({
        top: o,
        left: 0,
        behavior: "smooth"
    })
}
localStorage && (localStorage.setItem("windowId", b), window.addEventListener("focus", (function () {
...
class S extends HTMLElement {
    constructor({
        ...
        super(), void 0 !== t && (this.type = t), "error" !== this.type && null !== this.type || (this.type = "danger"), this.message = e, this.close = this.close.bind(this)
    }
    connectedCallback() {
        this.type = this.type || this.getAttribute("type"), "error" !== this.type && this.type || (this.type = "danger");
        const t = this.innerHTML,
            e = this.getAttribute("duration");
        let n = "";
        null !== e && (n = `<div class="alert__progress" style="animation-duration: ${e}s">`, window.setTimeout(this.close, 1e3 * e)), this.classList.add("alert"), this.classList.add(`alert-${this.type}`), this.innerHTML = `<svg class="icon icon-${this.icon}">\n          <use xlink:href="/sprite.svg#${this.icon}"></use>\n        </svg>\n        <div>\n          ${this.message||t}\n        </div>\n        <button class="alert-close">\n          <svg class="icon">\n            <use xlink:href="/sprite.svg#cross"></use>\n          </svg>\n        </button>\n        ${n}`, this.querySelector(".alert-close").addEventListener("click", (t => {
            t.preventDefault(), this.close()
        }))
    }
    close() {
        this.classList.add("out"), window.setTimeout((async () => {
            await
            function (t, e = 500) {
                return new Promise((n => {
                    t.style.height = `${t.offsetHeight}px`, t.style.transitionProperty = "height, margin, padding", t.style.transitionDuration = `${e}ms`, t.offsetHeight, t.style.overflow = "hidden", t.style.height = 0, t.style.paddingTop = 0, t.style.paddingBottom = 0, t.style.marginTop = 0, t.style.marginBottom = 0, window.setTimeout((() => {
                        t.style.display = "none", t.style.removeProperty("height"), t.style.removeProperty("padding-top"), t.style.removeProperty("padding-bottom"), t.style.removeProperty("margin-top"), t.style.removeProperty("margin-bottom"), t.style.removeProperty("overflow"), t.style.removeProperty("transition-duration"), t.style.removeProperty("transition-property"), n(t)
                    }), e)
                }))
            }(this), this.parentElement.removeChild(this), this.dispatchEvent(new CustomEvent("close"))
        }), 500)
    }
    get icon() {
        return "danger" === this.type ? "warning" : "success" === this.type ? "check" : this.type
    }
}
class P extends S {
    constructor(t = {}) {
...
function C(t, e = "success", n = 3) {
    ...
    n && r.setAttribute("duration", n), r.setAttribute("type", e), r.innerText = t, document.body.appendChild(r)
}
var L, T, R, A, x, N = {},
    H = [],
...
function $(t) {
    (!t.__d && (t.__d = !0) && T.push(t) && !j.__r++ || A !== L.debounceRendering) && ((A = L.debounceRendering) || R)(j)
}

function j() {
    for (var t; j.__r = T.length;) t = T.sort((function (t, e) {
        return t.__v.__b - e.__v.__b
    })), T = [], t.some((function (t) {
        var e, n, r, o, i, s;
        t.__d && (i = (o = (e = t).__v).__e, (s = e.__P) && (n = [], (r = q({}, o)).__v = o.__v + 1, tt(s, o, r, e.__n, void 0 !== s.ownerSVGElement, null != o.__h ? [i] : null, n, null == i ? V(o) : i, o.__h), et(n, o), o.__e != i && W(o)))
    }))
}

function z(t, e, n, r, o, i, s, a, l, u) {
    var c, h, p, d, f, _, y, m = r && r.__k || H,
        v = m.length;
    for (n.__k = [], c = 0; c < e.length; c++)
        if (null != (d = n.__k[c] = null == (d = e[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? M(null, d, null, null, d) : Array.isArray(d) ? M(F, {
                children: d
            }, null, null, null) : d.__b > 0 ? M(d.type, d.props, d.key, null, d.__v) : d)) {
            if (d.__ = n, d.__b = n.__b + 1, null === (p = m[c]) || p && d.key == p.key && d.type === p.type) m[c] = void 0;
            else
                for (h = 0; h < v; h++) {
            ...
            tt(t, d, p = p || N, o, i, s, a, l, u), f = d.__e, (h = d.ref) && p.ref != h && (y || (y = []), p.ref && y.push(p.ref, null, d), y.push(h, d.__c || f, d)), null != f ? (null == _ && (_ = f), "function" == typeof d.type && null != d.__k && d.__k === p.__k ? d.__d = l = K(d, l, t) : l = G(t, d, p, m, f, l), u || "option" !== n.type ? "function" == typeof n.type && (n.__d = l) : t.value = "") : l && p.__e == l && l.parentNode != t && (l = V(p))
        } for (n.__e = _, c = v; c--;) null != m[c] && ("function" == typeof n.type && null != m[c].__e && m[c].__e == n.__d && (n.__d = V(r, c + 1)), rt(m[c], m[c]));
    if (y)
        for (c = 0; c < y.length; c++) nt(y[c], y[++c], y[++c])
}

function K(t, e, n) {
    var r, o;
    for (r = 0; r < t.__k.length; r++)(o = t.__k[r]) && (o.__ = t, e = "function" == typeof o.type ? K(o, e, n) : G(n, o, o, t.__k, o.__e, e));
    return e
}
...
function G(t, e, n, r, o, i) {
    ...
    else if (null == n || o != i || null == o.parentNode) t: if (null == i || i.parentNode !== t) t.appendChild(o), s = null;
        else {
            for (a = i, l = 0;
...
function Y(t, e, n) {
    "-" === e[0] ? t.setProperty(e, n) : t[e] = null == n ? "" : "number" != typeof n || I.test(e) ? n : n + "px"
}
...
function J(t, e, n, r, o) {
    ...
    t: if ("style" === e)
        if ("string" == typeof n) t.style.cssText = n;
            ...
            if (n)
                for (e in n) r && n[e] === r[e] || Y(t.style, e, n[e])
        }
    else if ("o" === e[0] && "n" === e[1]) i = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + i] = n, n ? r || t.addEventListener(e, i ? Q : Z, i) : t.removeEventListener(e, i ? Q : Z, i);
...
function tt(t, e, n, r, o, i, s, a, l) {
    var u, c, h, p, d, f, _, y, m, v, g, b = e.type;
    if (void 0 !== e.constructor) return null;
    null != n.__h && (l = n.__h, a = e.__e = n.__e, e.__h = null, i = [a]), (u = L.__b) && u(e);
    try {
        t: if ("function" == typeof b) {
            if (y = e.props, m = (u = b.contextType) && r[u.__c], v = u ? m ? m.props.value : u.__ : r, n.__c ? _ = (c = e.__c = n.__c).__ = c.__E : ("prototype" in b && b.prototype.render ? e.__c = c = new b(y, v) : (e.__c = c = new U(y, v), c.constructor = b, c.render = ot), m && m.sub(c), c.props = y, c.state || (c.state = {}), c.context = v, c.__n = r, h = c.__d = !0, c.__h = []), null == c.__s && (c.__s = c.state), null != b.getDerivedStateFromProps && (c.__s == c.state && (c.__s = q({}, c.__s)), q(c.__s, b.getDerivedStateFromProps(y, c.__s))), p = c.props, d = c.state, h) null == b.getDerivedStateFromProps && null != c.componentWillMount && c.componentWillMount(), null != c.componentDidMount && c.__h.push(c.componentDidMount);
            else {
                if (null == b.getDerivedStateFromProps && y !== p && null != c.componentWillReceiveProps && c.componentWillReceiveProps(y, v), !c.__e && null != c.shouldComponentUpdate && !1 === c.shouldComponentUpdate(y, c.__s, v) || e.__v === n.__v) {
                ...
                null != c.componentWillUpdate && c.componentWillUpdate(y, c.__s, v), null != c.componentDidUpdate && c.__h.push((function () {
                    c.componentDidUpdate(p, d, f)
                }))
            }
            c.context = v, c.props = y, c.state = c.__s, (u = L.__r) && u(e), c.__d = !1, c.__v = e, c.__P = t, u = c.render(c.props, c.state, c.context), c.state = c.__s, null != c.getChildContext && (r = q(q({}, r), c.getChildContext())), h || null == c.getSnapshotBeforeUpdate || (f = c.getSnapshotBeforeUpdate(p, d)), g = null != u && u.type === F && null == u.key ? u.props.children : u, z(t, Array.isArray(g) ? g : [g], e, n, r, o, i, s, a, l), c.base = e.__e, e.__h = null, c.__h.length && s.push(c), _ && (c.__E = c.__ = null), c.__e = !1
        } else null == i && e.__v === n.__v ? (e.__k = n.__k, e.__e = n.__e) : e.__e = function (t, e, n, r, o, i, s, a) {
            var l, u, c, h, p = n.props,
                d = e.props,
                f = e.type,
                _ = 0;
            if ("svg" === f && (o = !0), null != i)
                for (; _ < i.length; _++)
                    if ((l = i[_]) && (l === t || (f ? l.localName == f : 3 == l.nodeType))) {
                        t = l, i[_] = null;
                        break
                    } if (null == t) {
                if (null === f) return document.createTextNode(d);
                t = o ? document.createElementNS("http://www.w3.org/2000/svg", f) : document.createElement(f, d.is && d), i = null, a = !1
            }
            if (null === f) p === d || a && t.data === d || (t.data = d);
            else {
                if (i = i && H.slice.call(t.childNodes), u = (p = n.props || N).dangerouslySetInnerHTML, c = d.dangerouslySetInnerHTML, !a) {
                    if (null != i)
                        for (p = {}, h = 0; h < t.attributes.length; h++) p[t.attributes[h].name] = t.attributes[h].value;
                ...
                else if (_ = e.props.children, z(t, Array.isArray(_) ? _ : [_], e, n, r, o && "foreignObject" !== f, i, s, t.firstChild, a), null != i)
                    for (_ = i.length; _--;) null != i[_] && D(i[_]);
                a || ("value" in d && void 0 !== (_ = d.value) && (_ !== t.value || "progress" === f && !_) && J(t, "value", _, p.value, !1), "checked" in d && void 0 !== (_ = d.checked) && _ !== t.checked && J(t, "checked", _, p.checked, !1))
            }
            return t
        }(n.__e, e, n, r, o, i, s, l);
        (u = L.diffed) && u(e)
        ...
        e.__v = null, (l || null != i) && (e.__e = a, e.__h = !!l, i[i.indexOf(a)] = null), L.__e(w, e, n)
    }
}
...
function rt(t, e, n) {
    var r, o, i;
    if (L.unmount && L.unmount(t), (r = t.ref) && (r.current && r.current !== t.__e || nt(r, null, e)), n || "function" == typeof t.type || (n = null != (o = t.__e)), t.__e = t.__d = void 0, null != (r = t.__c)) {
    ...
    if (r = t.__k)
        for (i = 0; i < r.length; i++) r[i] && rt(r[i], e, n);
    null != o && D(o)
}
...
function it(t, e, n) {
    var r, o, i;
    L.__ && L.__(t, e), o = (r = "function" == typeof n) ? null : n && n.__k || e.__k, i = [], tt(e, t = (!r && n || e).__k = B(F, null, [t]), o || N, N, void 0 !== e.ownerSVGElement, !r && n ? [n] : o ? null : e.firstChild ? H.slice.call(e.childNodes) : null, i, !r && n ? n : o ? o.__e : e.firstChild, r), et(i, t)
}
...
function at(t, e, n) {
    ...
    if (arguments.length > 3)
        for (n = [n], i = 3; i < arguments.length; i++) n.push(s[i]);
    return null != n && (a.children = n), M(t.type, a, r || t.key, o || t.ref, null)
}
...
L = {
    ...
    var n;
    n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = q({}, this.state), "function" == typeof t && (t = t(q({}, n), this.props)), t && q(n, t), null != t && this.__v && (e && this.__h.push(e), $(this))
}, U.prototype.forceUpdate = function (t) {
    this.__v && (this.__e = !0, t && this.__h.push(t), $(this))
}, U.prototype.render = F, T = [], R = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, j.__r = 0, x = 0;
var ut, ct, ht, pt = 0,
    dt = [],
    ft = L.__b,
    _t = L.__r,
...
function wt(t, e, n) {
    var r = gt(ut++, 2);
    return r.t = t, r.__c || (r.__ = [n ? n(e) : qt(void 0, e), function (t) {
        var e = r.t(r.__[0], t);
...
function Tt(t) {
    var e = ct.context[t.__c],
        n = gt(ut++, 9);
    return n.__c = t, e ? (null == n.__ && (n.__ = !0, e.sub(ct)), e.props.value) : t.__
}
...
L.__b = function (t) {
    ...
    yt && yt(t);
    var e = t.__c;
    e && e.__H && e.__H.__h.length && (1 !== dt.push(e) && ht === L.requestAnimationFrame || ((ht = L.requestAnimationFrame) || function (t) {
        var e, n = function () {
    ...
    e.some((function (t) {
        try {
            t.__h.forEach(Nt), t.__h = t.__h.filter((function (t) {
                return !t.__ || Ht(t)
            }))
        } catch (n) {
            e.some((function (t) {
...
function Ot(t, e) {
    function n(t) {
        var n = this.props.ref,
            r = n == t.ref;
        return !r && n && (n.call ? n(null) : n.current = null), e ? !e(this.props, t) || !r : Bt(this.props, t)
    }
...
}(Mt.prototype = new U).isPureReactComponent = !0, Mt.prototype.shouldComponentUpdate = function (t, e) {
    return Bt(this.props, t) || Bt(this.state, e)
};
var Ft = L.__b;
L.__b = function (t) {
    t.type && t.type.__f && t.ref && (t.props.ref = t.ref, t.ref = null), Ft && Ft(t)
};
var Ut = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.forward_ref") || 3911;
...
function Vt(t) {
    ...
    return e.$$typeof = Ut, e.render = e, e.prototype.isReactComponent = e.__f = !0, e.displayName = "ForwardRef(" + (t.displayName || t.name) + ")", e
}
var Wt = function (t, e) {
    ...
    if (this.__b) {
        if (this.__v.__k) {
            ...
            this.__v.__k[0] = function t(e, n, r) {
                ...
                })), e.__c.__H = null), null != (e = Dt({}, e)).__c && (e.__c.__P === r && (e.__c.__P = n), e.__c = null), e.__k = e.__k && e.__k.map((function (e) {
                    return t(e, n, r)
                }))), e
...
var ee = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103,
    ne = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
    re = function (t) {
        return ("undefined" != typeof Symbol && "symbol" == typeof Symbol() ? /fil|che|rad/i : /fil|che|ra/i).test(t)
    };

function oe(t, e, n) {
    return null == e.__k && (e.textContent = ""), it(t, e), "function" == typeof n && n(), t ? t.__c : null
}
...
L.event = function (t) {
    return se && (t = se(t)), t.persist = ae, t.isPropagationStopped = le, t.isDefaultPrevented = ue, t.nativeEvent = t
};
var ce, he = {
        configurable: !0,
        get: function () {
...
L.vnode = function (t) {
    ...
    if ("string" == typeof e) {
        for (var o in r = {}, n) {
            var i = n[o];
            "value" === o && "defaultValue" in n && null == i || ("defaultValue" === o && "value" in n && null == n.value ? o = "value" : "download" === o && !0 === i ? i = "" : /ondoubleclick/i.test(o) ? o = "ondblclick" : /^onchange(textarea|input)/i.test(o + e) && !re(n.type) ? o = "oninput" : /^on(Ani|Tra|Tou|BeforeInp)/.test(o) ? o = o.toLowerCase() : ne.test(o) ? o = o.replace(/[A-Z0-9]/, "-$&").toLowerCase() : null === i && (i = void 0), r[o] = i)
        }
    ...
    e && n.class != n.className && (he.enumerable = "className" in n, null != n.className && (r.class = n.className), Object.defineProperty(r, "className", he)), t.$$typeof = ee, pe && pe(t)
};
var de = L.__r;
L.__r = function (t) {
    de && de(t), ce = t.__c
...
var _e = "object" == typeof performance && "function" == typeof performance.now ? performance.now.bind(performance) : function () {
    return Date.now()
};
...
var we = function (t, e) {
    ...
    Se = Object.freeze({
        ...
        useErrorBoundary: function (t) {
            var e = gt(ut++, 10),
                n = bt();
            return e.__ = t, ct.componentDidCatch || (ct.componentDidCatch = function (t) {
                e.__ && e.__(t), n[1](t)
            }), [n[0], function () {
                n[1](void 0)
            }]
...
async function Le(t, e = {}) {
    e.body instanceof FormData && (e.body = Object.fromEntries(e.body)), e.body && "object" == typeof e.body && (e.body = JSON.stringify(e.body)), e = a({
        headers: {
...
class Ae {
    ...
    violationsFor(t) {
        return this.data.violations.filter((e => e.propertyPath === t)).map((t => t.message))
    }
    get name() {
        return `${this.data.title} ${this.data.detail||""}`
    }
    get violations() {
        return this.data.violations ? this.data.violations.reduce(((t, e) => (t[e.propertyPath] ? t[e.propertyPath].push(e.message) : t[e.propertyPath] = [e.message], t)), {}) : {
...
function Ie(t) {
    ...
    return r = m("btn", r, i && `btn-${i}`), B("button", a({
        className: r,
        disabled: o
    }, s), o && B(xe, {
        className: "icon"
...
function De({
    ...
    const o = {};
    return e && (o["--gap"] = e), n && (o["align-items"] = "center"), r && (o["flex-wrap"] = "nowrap"), B("div", {
        class: "hstack",
        style: o
    }, t)
}
...
const Me = {},
    Oe = function (t, e) {
        ...
        if (void 0 === Be) {
            ...
            Be = t && t.supports && t.supports("modulepreload") ? "modulepreload" : "preload"
        }
        return Promise.all(e.map((t => {
            ...
            return r.rel = e ? "stylesheet" : Be, e || (r.as = "script", r.crossOrigin = ""), r.href = t, document.head.appendChild(r), e ? new Promise(((t, e) => {
...
function Ve(t, e) {
    Et((() => {
        ...
        return document.addEventListener("click", r), document.addEventListener("keyup", n),
            function () {
                document.removeEventListener("click", r), document.removeEventListener("keyup", n)
            }
    }), [t, e])
}
...
function je(t, e = !0, n = {}) {
    const [r, o] = bt(!1), i = St(), s = e && r ? null : new IntersectionObserver((t => {
        const e = t[0];
        i.current !== e.isIntersecting && (o(e.isIntersecting), i.current = e.isIntersecting)
    }), n);
    return Et((() => {
        const e = t instanceof HTMLElement ? t : t.current;
        if (e && null !== s) return s.observe(e),
            function () {
                s.unobserve(e)
            }
    })), r
...
function Ke(t) {
    $e((async () => {
        if (null === ze) {
            if (0 === t) return;
            return await Oe((() => import("./FavIconBadge.fc7a67d8.js")), void 0), ze = d('<favicon-badge src="/favicon.ico" badge="true" badgeSize="6"/>'), void document.head.appendChild(ze)
        }
...
function Xe(t) {
    var e = t,
        ...
        d = u(e, ["name", "onInput", "value", "error", "children", "type", "className", "wrapperClass", "component"]);
    const [f, _] = bt(!1), y = St(null);
    ! function (t, e) {
        Et((() => {
            if (e && t.current) {
...
function en({
    ...
    const [{
        ...
        if (!c[t]) return null;
        const e = a({}, c);
        delete e[t], h((t => l(a({}, t), {
            errors: e
        })))
    };
    return B(tn.Provider, {
        value: {
            loading: u,
            errors: c,
            emptyError: d
...
function rn(t) {
    ...
    const {
        loading: o,
        errors: i
    } = Tt(tn), s = o || Object.keys(i).filter((t => "main" !== t)).length > 0;
    return B(Ne, a({
        loading: o,
        disabled: s
    }, r), n)
...
var sn = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
...
un = cn,
    function () {
        ...
        (function () {
            (function () {
                ...
                t.copyObject = function (t) {
                    ...
                    return e.call(t, n)
                }, e = null != (i = document.documentElement.closest) ? i : function (t) {
                    var e;
                    for (e = this; e;) {
                    ...
                    return e = null,
                        function () {
                            var n, r;
                            return n = 1 <= arguments.length ? s.call(arguments, 0) : [], null != e ? e : e = requestAnimationFrame((r = this, function () {
                                return e = null, t.apply(r, n)
                            }))
                        }
                }, t.dispatch = function (t, e) {
                    var n, o, i, s, a, l;
                    return l = (a = null != e ? e : {}).target, n = a.cancelable, o = a.data, (i = document.createEvent("Events")).initEvent(t, !0, !0 === n), i.data = null != o ? o : {}, i.cancelable && !r && (s = i.preventDefault, i.preventDefault = function () {
                ...
                }, (o = document.createEvent("Events")).initEvent("test", !0, !0), o.preventDefault(), r = o.defaultPrevented, t.match = function (t, e) {
                    return n.call(t, e)
                }, n = function () {
                    var t, e, n, r;
                ...
                function () {
                    t.BrowserAdapter = function () {
                        function e(e) {
                            var n, r;
                            this.controller = e, this.showProgressBar = (n = this.showProgressBar, r = this, function () {
                                return n.apply(r, arguments)
                            }), this.progressBar = new t.ProgressBar
                        }
                        var n, r, o;
                        return o = t.HttpRequest, n = o.NETWORK_FAILURE, r = o.TIMEOUT_FAILURE, e.prototype.visitProposedToLocationWithAction = function (t, e) {
                ...
                function () {
                    ...
                    t.History = function () {
                        ...
                        return n.prototype.start = function () {
                            ...
                            return t.defer((n = this, function () {
                ...
                function () {
                    t.Snapshot = function () {
                        ...
                        return e.wrap = function (t) {
                            ...
                            var n, r, o;
                            return r = e.querySelector("head"), n = null != (o = e.querySelector("body")) ? o : document.createElement("body"), new this(t.HeadDetails.fromHeadElement(r), n)
                        ...
                        }, e.prototype.getPermanentElementsPresentInSnapshot = function (t) {
                            var e, n, r, o, i;
                ...
                function () {
                    ...
                    t.Renderer = function () {
                        ...
                        return t.render = function () {
                            var t, n, r;
                            return n = arguments[0], t = arguments[1], (r = function (t, e, n) {
                            ...
                            var n, r, o, i, s, a, l;
                            for (a = [], n = 0, r = (i = e.attributes).length; r > n; n++) o = (s = i[n]).name, l = s.value, a.push(t.setAttribute(o, l));
                            return a
                        }, t
                    }()
                }.call(this),
                function () {
                    ...
                    t.SnapshotRenderer = function (t) {
                        ...
                        return function (t, e) {
                        ...
                        }(o, t), o.prototype.render = function (t) {
                            ...
                            var t, r, o, i, s, a, l;
                            for (l = [], t = 0, r = (a = this.getCurrentBodyPermanentElements()).length; r > t; t++) i = a[t], s = e(i), o = this.newSnapshot.getPermanentElementById(i.id), n(i, s.element), n(o, i), l.push(s);
                            return l
                        }, o.prototype.replacePlaceholderElementsWithClonedPermanentElements = function (t) {
                            var e, r, o, i, s, a;
                            for (a = [], o = 0, i = t.length; i > o; o++) r = (s = t[o]).element, e = s.permanentElement.cloneNode(!0), a.push(n(r, e));
                            return a
                        }, o.prototype.activateNewBodyScriptElements = function () {
                            var t, e, r, o, i, s;
                            for (s = [], e = 0, o = (i = this.getNewBodyScriptElements()).length; o > e; e++) r = i[e], t = this.createScriptElement(r), s.push(n(r, t));
                            return s
                ...
                function () {
                    ...
                    t.ErrorRenderer = function (t) {
                        ...
                        return function (t, n) {
                            ...
                            r.prototype = n.prototype, t.prototype = new r, t.__super__ = n.prototype
                        }(n, t), n.prototype.render = function (t) {
                ...
                function () {
                    t.ScrollManager = function () {
                        function e(e) {
                            var n, r;
                            this.delegate = e, this.onScroll = (n = this.onScroll, r = this, function () {
                                return n.apply(r, arguments)
                ...
                function () {
                    t.Visit = function () {
                        function e(e, n, r) {
                            var o, i;
                            this.controller = e, this.action = r, this.performScroll = (o = this.performScroll, i = this, function () {
                                return o.apply(i, arguments)
                            }), this.identifier = t.uuid(), this.location = t.Location.wrap(n), this.adapter = this.controller.adapter, this.state = "initialized", this.timingMetrics = {}
                        }
                        var n;
                        return e.prototype.start = function () {
                ...
                function () {
                    ...
                    t.Controller = function () {
                        ...
                        return n.prototype.start = function () {
                            ...
                            var o;
                            return t.supported ? (o = this.getRestorationDataForIdentifier(r), this.startVisit(e, n, {
                                restorationData: o
                            })) : window.location = e
                            ...
                            var e, n, r;
                            return this.shouldCacheSnapshot() ? (this.notifyApplicationBeforeCachingSnapshot(), n = this.view.getSnapshot(), e = this.lastRenderedLocation, t.defer((r = this, function () {
                            ...
                            var o, i, s, a, l;
                            return a = (i = null != r ? r : {}).restorationIdentifier, s = i.restorationData, o = i.historyChanged, (l = new t.Visit(this, e, n)).restorationIdentifier = null != a ? a : t.uuid(), l.restorationData = t.copyObject(s), l.historyChanged = o, l.referrer = this.location, l
        ...
        }).call(this), un.exports && (un.exports = t)
    }.call(sn);
var hn = cn.exports;
...
class fn extends HTMLElement {
    ...
    attributeChangedCallback() {
        ...
        null != this.root.querySelector(".circles") && (this.root.querySelector(".circles").innerHTML = this.buildCircles(e, n, r / 2))
    }
    ...
    buildCircles(t, e, n) {
        ...
        for (let i = 0; i < e; i++) {
            ...
            o += `<circle cx="${r*Math.sin(s)+t/2}" cy="${r*Math.cos(s)+t/2}" r="${n}" fill="currentColor"/>`
        }
        return o
    }
    buildTrail(t, e) {
...
function _n(t, e, n, r) {
    function o() {
        ...
        return t._vdomComponent = e, t._root = r && r.shadow ? t.attachShadow({
            mode: "open"
        }) : t, t
    }
    return o.prototype = Object.create(HTMLElement.prototype), o.prototype.constructor = o, o.prototype.connectedCallback = mn, o.prototype.attributeChangedCallback = gn, o.prototype.disconnectedCallback = bn, n = n || e.observedAttributes || Object.keys(e.propTypes || {}), o.observedAttributes = n, n.forEach((t => {
...
function mn() {
    ...
    this._vdom = B(yn, l(a({}, this._props), {
        context: e
    }), En(this, this._vdomComponent)), (this.hasAttribute("hydrate") ? st : it)(this._vdom, this._root)
}
...
function gn(t, e, n) {
    ...
    n = null == n ? void 0 : n;
    const r = {};
    r[t] = n, r[vn(t)] = n, this._vdom = at(this._vdom, r), it(this._vdom, this._root)
}
...
function wn(t, e) {
    return B("slot", l(a({}, t), {
        ref: t => {
            t ? (this.ref = t, this._listener || (this._listener = t => {
                t.stopPropagation(), t.detail.context = e
            }, t.addEventListener("_preact", this._listener))) : this.ref.removeEventListener("_preact", this._listener)
        }
    }))
}
...
function En(t, e) {
    ...
    const i = t.attributes,
        s = t.childNodes;
    for (o = i.length; o--;) "slot" !== i[o].name && (r[i[o].name] = i[o].value, r[vn(i[o].name)] = i[o].value);
...
function kn({
    ...
    return te(B("modal-dialog", {
        "overlay-close": !0,
        onClose: e
    }, B("section", {
        className: m("modal-box", n && `p${n}`, o),
        style: r
    }, t)), document.body)
}
export {
    _ as $, Lt as A, qe as B, E as C, Fe as D, C as E, De as F, We as G, m as H, te as I, Ie as J, _n as K, xe as L, kn as M, on as N, Ae as O, Ne as P, Ge as Q, v as R, He as S, Te as T, g as U, S as V, P as W, fn as X, Pe as Y, Ce as Z, Oe as _, B as a, y as a0, hn as a1, pn as a2, it as a3, ln as a4, Se as a5, sn as a6, an as a7, p as a8, $e as b, k as c, Ct as d, ke as e, F as f, Ot as g, Re as h, Xe as i, Le as j, d as k, bt as l, h as m, f as n, c as o, w as p, Ue as q, dn as r, St as s, Ke as t, je as u, Ve as v, nn as w, en as x, Et as y, rn as z
};
